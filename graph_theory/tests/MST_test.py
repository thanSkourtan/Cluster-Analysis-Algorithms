...
class Test(unittest.TestCase):
    ...
    def testBlobs(self):
        ...
        # Create the dataset
        X, y = make_blobs(n_samples = 500, centers= no_of_clusters, n_features=2,random_state=111)
        
        # Run the clustering algorithm but first run a sequential algorithm to obtain initial centroids
        X, no_of_clusters = MST.minimum_spanning_tree(X, k = 6, f = 3.5)
    ...
    def testCircles(self):
        ...
        # Create the dataset
        X, y = make_circles(n_samples=500, shuffle = True, noise = 0.05, factor = 0.5, random_state = 107)
    ...
    def testMoons(self):
        ...
        # Create the dataset
        X, y = make_moons(n_samples=300, shuffle = True, noise = 0.07, random_state = 10)
        
        # Run the clustering algorithm
        X, no_of_clusters = MST.minimum_spanning_tree(X)
    ...
    def testRelativeCircles(self):
        ...
        # Create the dataset
        X, y = make_circles(n_samples=1000, shuffle = True, noise = 0.05, factor = 0.5, random_state = 104)
    ...
    def testRelativeMoons(self):
        ...
        # Create the dataset
        X, y = make_moons(n_samples=500, shuffle = True, noise = 0.07, random_state = 107)
